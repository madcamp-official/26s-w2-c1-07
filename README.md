...
| 단계 | 목표 |
|---|---|
| 1주차 | Unity 프로젝트 셋업, NGO + Facepunch 접속·이동 동기화 PoC, 웹 프로토 규칙 이식 시작 |
| 2주차 | 지형·캐릭터·카메라, 매치 FSM·모드 3종·점수 |
| 3주차 | 준비 페이즈(배치·투표·룰렛)·하이라이트·아트 폴리싱 |
| 이후 | Steamworks 상점 페이지·빌드·플레이테스트·출시 준비 |
